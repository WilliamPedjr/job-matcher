...
import "../styles/JobViewPage.css"

function parseSkills(skillsText) {
  if (!skillsText) return []
  if (Array.isArray(skillsText)) {
    return skillsText.map((skill) => String(skill).trim()).filter(Boolean)
  }

  const normalized = String(skillsText).trim()
    ...
    <section className="job-view-page">
      ...
      <div className="job-view-card">
        ...
        <div className="job-view-info-grid">
          ...
          <div className="job-view-info-item">
            <span>Job Position Type</span>
            <strong>{job.jobPosition || job.job_position || "-"}</strong>
          </div>
          <div className="job-view-info-item">
            <span>Item No.</span>
