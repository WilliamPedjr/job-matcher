...
function ApplicantViewPage({ viewItem, onBack, onReanalyze }) {
  ...
  const experienceMatch = /\d+\+?\s*years?/i.test(viewItem?.extracted_text || "") ? 55 : 0
      ...
      <div className="candidate-layout">
        <div className="candidate-left">
          ...
          <section className="candidate-card">
            ...
            <p className="muted">
              {/\d+\+?\s*years?/i.test(viewItem?.extracted_text || "")
                ? "Experience references detected in resume."
                : "No clear work experience extracted."}
            </p>
          </section>
        </div>
